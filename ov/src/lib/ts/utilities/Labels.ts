...
//
// The kind and the tags are not written. Since 10 September 2026 they live in the db beside the
// dispatcher, never in the file, and a block that still carries the two lines loses them the
// next time it is written. The tags are still handed in, since every caller has them to hand.
export function label_block(labels: Labels, _tags: string[]): string {
