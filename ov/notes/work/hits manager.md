...
2. **A scroll shifts rectangles by the distance scrolled** — [Hits.ts:181-192](vscode-webview://081v1990oep8ie604s97pudvrnipbh0so5lle4fbgfctemaevakk/ov/src/lib/ts/events/Hits.ts#L181-L192), asked by the list ([Files.svelte:209-217](vscode-webview://081v1990oep8ie604s97pudvrnipbh0so5lle4fbgfctemaevakk/ov/src/lib/svelte/content/Files.svelte#L209-L217)) and the file's words ([File_Content.svelte:66-72](vscode-webview://081v1990oep8ie604s97pudvrnipbh0so5lle4fbgfctemaevakk/ov/src/lib/svelte/content/File_Content.svelte#L66-L72)). Nothing is read from the browser; asking which targets are inside a box walks up from each element, which forces no layout.
