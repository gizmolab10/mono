...
#
# Those are the ones guides link to: the handoff, the debt, the journal — and what sits one
# folder down inside the named work folders. Anything deeper stays out, so the list grows
...
code, said = ask('/read-guide?where=memory/lv/notes/CLAUDE.md')
