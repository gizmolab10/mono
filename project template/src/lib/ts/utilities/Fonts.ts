// Preloads the latin Montserrat files (weights 300, 400, 500) the instant the bundle
// runs, so the browser fetches them in parallel and can have them ready by the
// first paint — this keeps text from reflowing when the web font would otherwise
// arrive late and swap in over the fallback.
//
