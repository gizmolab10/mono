...
Jonathan types `t`. Translate. It means the sentence just written could not be read, and he wants it
again in words that work.

Murk is writing that is challenging to understand. That is the whole definition, and it is enough,
...
4. **What is measured is what gets obeyed.** Leave clarity unmeasured beside a mechanically enforced
   word list, and the writer will spend his attention on the word list — correctly, because that is
   the only part with consequences.
5. **A guide teaches twice**, once by what it says and once by how it reads. The second lesson is the
   stronger one, and it is the one nobody proofreads.
...
Every strategy above was pulled out of one case: this collection's own rule set, which was found to
be manufacturing the murk it forbade. The hypothesis, the twelve causes, the counting hook and the
daily rate all live in the record — [murk.md](../../../ov/notes/work/soon/murk%20journal.md).

That record is still open. Six of the twelve causes are closed, and three parts of the machine have
never been examined.
