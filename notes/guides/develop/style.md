...
**Project-specific conventions**: See project-specific style guides for import patterns.
...
- Use `$:` for reactive statements (Svelte 4) or `$derived()` (Svelte 5)
...
See project-specific style guides for import patterns and manager access conventions.
...
2. Imports
3. Component props (`export let` for Svelte 4, `let { } = $props()` for Svelte 5)
4. Local constants/variables
5. Reactive statements (`$:` for Svelte 4, `$derived()` for Svelte 5)
6. Functions
7. Template
