...
| `update`, `done`                  | simplify code debt by moving checked off things to code debt paid. simplify and tighten handoff, moving done things to work journal. update work journal, working features, map and file layout                                                                         |
| `setup`                           | for the current project, create whatever `notes/work/now/` files are missing per the minimal set in `notes/guides/collaborate/workflow.md`: `code.debt.md` always; `handoff.md` and the rest only when asked. never overwrite an existing file; report what got created |
