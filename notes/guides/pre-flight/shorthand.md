...
| `update`, `done`                  | simplify code debt by moving done things to code debt paid. simplify and tighten handoff, moving done things to work journal. update work journal, working features, map and file layout |
