...
1. **index.md** - Links should be updated:
   - `[[notes/tools/docs/test/fixtures/advanced/test-moved]]` → `[[notes/tools/docs/test/fixtures/advanced/test-moved]]`
   - `[Link to moved file](notes/tools/docs/test/fixtures/advanced/test-moved.md)` → `[Link to moved file](notes/tools/docs/test/fixtures/advanced/test-moved.md)`
   - `[Link with anchor](notes/tools/docs/test/fixtures/advanced/test-moved.md#section-one)` → `[Link with anchor](notes/tools/docs/test/fixtures/advanced/test-moved.md#section-one)`
