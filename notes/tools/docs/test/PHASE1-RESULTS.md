...
- ✅ Updated wikilinks: `[[notes/tools/docs/test/fixtures/advanced/test-moved]]` → `[[notes/tools/docs/test/fixtures/advanced/test-moved]]`
- ✅ Updated markdown links: `[text](notes/tools/docs/test/fixtures/advanced/test-moved.md)` → `[text](notes/tools/docs/test/fixtures/advanced/test-moved.md)`
