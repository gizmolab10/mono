...
class SyncSidebar {
    ...
    async sync() {
        ...
        const newConfigContent = configContent.substring(0, openBracket) +
            newSidebarStr +
    ...
    formatSidebarWithKept(sidebar, keptItems, indent = 8) {
        const lines = ['['];
    ...
    formatItem(item, indent, lines, isLast) {
