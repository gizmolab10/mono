...
- music and ai.md — the plan, kb's for a day and back in [memory/ai/zone](../ai/zone/work/music%20and%20ai.md) since 15 September 2026: what kb holds, what a specialty is, the ai and music specialties each defined with a key values table, the db tables, one db per host, and the 32 steps, ai on kb first, then the strip of ov, then music, kb's new work, the drop box and mu adopting kb.
