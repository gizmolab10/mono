...
Ongoing work for overview.

The proposal that started this project is in ji, at `ji/notes/work/proposals/ov.md`.

- [[memory/ov/zone/work/AI memory redesign]] — start over!
- [[memory/ov/zone/work/assessment of our guides]] — out of date
- [[memory/ov/zone/work/AI on my mac]] — abandon claude subscriptions
...
- [Work journal](memory/ov/logs/work%20journal.md) — what's been finished, newest first.

One folder down:

- [Soon](soon/index.md) — work that is coming, kept out of the way until it is.

Elsewhere:

- [Sections spec](sections%20spec.md) — everything needed to build the stack in another project, in the order it has to be done. **mono**
...
- [Memory-system-design](memory/ov/zone/work/AI%20memory%20redesign.md)
