...
**Direct evidence:** ov's [code debt](../../../../ov/ov/notes/work/code%20debt.md) done list runs to a hundred lines, and nothing prompts the move to a paid file.
