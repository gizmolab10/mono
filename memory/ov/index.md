...
- [adopt kb.md](zone/adopt%20kb.md) — what a host hands kb, proposed: the switches, one field per fact with ai's and mu's values, the four snippets and where kb renders each, what is not handed, the type, its proof and what is open. Moves to memory/kb at step 4 of the plan.
