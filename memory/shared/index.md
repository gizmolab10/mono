...
- [unfinished.md](truth/unfinished.md) — what the unfinished file is: the row, the eight patterns counted by grep, the walk, the script that writes it and its test.
...
- [unfinished.md](zone/unfinished.md) — one line per memory file holding unfinished work, across every project. Written by tools/unfinished.py, never by hand.
