...
- [per-guide fates.md](zone/per-guide%20fates.md) — the folder-by-folder detail behind the guides sorting, the drive for an afternoon of 19 September 2026, its batch B in the work journal: of the 142 now in truth/, 91 stay, 17 fold, 22 archive, 6 to zone, 9 to ws's manual, 6 die; the mechanical move is built, the sorting is a pending pac in shared's decisions.md, the drive dissolved. ov's until 15 September 2026, as is everything below from ov. ov's, then ai's, until 15 September 2026.
- [garolous truths.md](zone/garolous%20truths.md) — the shortening of the truths over 100 lines, the sorting's third part: the proposal and the table of the 62 files, largest first, counted 19 September 2026.
- [system failure.md](zone/system%20failure.md) — where the memory system's rules did not reach co's replies: the pattern in learn.md's corrections, written 20 September 2026.
