...
ov. ov's own four hold 980 lines that panel does not, and the way ov incorporates panel is an open proposal in [proposals](memory/ov/zone/proposals.md). These steps are for a host whose `App.svelte` draws a line or nothing.
