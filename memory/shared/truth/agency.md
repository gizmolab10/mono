...
24. **Show the gate** — on a `go`, the reply begins the answer to "what was checked before the first edit?" — the plan's lines quoted, the search's full file list, the hypotheses under test. *The output is the gate. If it's missing or thin, the step was skipped.*
