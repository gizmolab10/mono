...
| A why answered with a paragraph; evidence beside the answer; a part-answer closing the whole; "huh?" answered with more | `conventions.md` Response #10 |
| The how before the statement; branches in two grammars; slip, switch, branch and flag for the thing itself; a name from the wrong side | `conventions.md` Response #11 |
| A plan in five lists, questions at its end, a risk as a level, the road not taken | `collaborate/write a plan.md` |
| A file with a row renamed by git and edited at once | `pitfalls.md` #22 |
| A headless press or drag on the wrong file | `pitfalls.md` #23 |
| A browser fault hunted outside a browser | `pitfalls.md` #24 |
