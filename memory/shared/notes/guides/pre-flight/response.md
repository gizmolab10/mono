...
Everything about how a reply is written, apart from the eight in [always](always.md). Those eight are never repeated here; they are the ones that must never be out of sight.
