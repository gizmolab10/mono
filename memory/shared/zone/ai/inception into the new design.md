...
- [ ] Live files (`memory/<project>/notes/work/*`) still to come: current context, work journal, learn
...
- [ ] `memory/shared/zone/learn.md` — cross-project lessons (the rules they taught, not the stories)
