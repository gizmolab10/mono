...
The files were read. Nothing is published outside mono, so the first situation applies. The concrete recommendation is the proposal "libraries resolve through the workspace, not through aliases" in [proposals](memory/ov/zone/proposals.md).
