...
**Drive dissolved 7 September 2026:** the mechanical move is done and logged; this file is the detail behind the pac, decided 19 September 2026 and made the drive, see zone/drive.md. **Moved 7 September 2026:** all 19 folders sit whole under `truth/` in their project, `git mv`, links re-pointed, no `notes/guides/` folder remains anywhere. **The drive for the afternoon of 19 September 2026**, Jonathan's answers YES to both open questions. Batch A done that day: every archive move, every zone move, the cross-project truth moves and the manuals out. Batch B decided by Jonathan, the merges, the deletions and the shortening, its first merge at v; the plan with his ticks is in the work journal under 19 September, since the four words took the drive.
...
**shared/collaborate — 14.** Truth: `voice.md` (213 lines), `avoid murk.md`, `breakdown.md`, `hooks.md` (251), `exclude from maps.md`, `skills.md`. Fold: `chat.md` (277, who does what and what co must do) into conventions.md and agency.md — most of it is already there, rebuilt in September; `workflow.md` (184, propose before acting) into agency #7 and the shorthand; `expectations.md`, `context filters.md` and `jonathan.md` into conventions.md; `cadence.md` into whichever of those takes workflow. Archive: `composition.md` (Svelte component patterns, January), `write a journal.md` (the journals are old notes now).
