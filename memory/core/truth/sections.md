...
Still on its section: [Search.svelte:198](../../../../../notes/src/lib/svelte/filter/Search.svelte#L198), which carries the way out's press and now says so.
...
[Stack.svelte](../../../../../notes/src/lib/svelte/support/Stack.svelte) and [Stacked.ts](../../../../../notes/src/lib/ts/types/Stacked.ts). Three stacks so far:

- **Browse's three picking rows** — [Browse_Filters.svelte:298](../../../../../notes/src/lib/svelte/filter/Browse_Filters.svelte#L298). Browse's count row now draws its own separator only while the tags row is open.
- **The editor's label form** — [Editor_Filters.svelte:317](../../../../../notes/src/lib/svelte/filter/Editor_Filters.svelte#L317). Three sections: the words, the kinds, the tags. The kinds no longer stand inside the label rows; each answers for itself. With its tags open the stack draws no closing line, so the form draws its own — the same as the details column does.
- **The details column** — [Details.svelte:88](../../../../../notes/src/lib/svelte/main/Details.svelte#L88). Two sections, and `Hideable.svelte` is gone: it built a fold word and handed it to its own section, which the stack does now. It says `foot='below'` and draws that boundary itself, open or folded.
...
[Search.svelte](../../../../../notes/src/lib/svelte/filter/Search.svelte), [Browse.svelte](../../../../../notes/src/lib/svelte/main/Browse.svelte), [Sectioning.ts](../../../../../notes/src/lib/ts/utilities/Sectioning.ts), [Section.svelte](../../../../../notes/src/lib/svelte/support/Section.svelte)
