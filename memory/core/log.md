...
- D: both hosts draw core's Hamburger — it registers with the hits manager the way ov's did, taking its name, its press, its spoken label and its hint as props. ov's markup and its two consts are gone; its three styling rules are wrapped in :global so they reach a button core draws, since svelte scopes a file's styles to that file. core clean at 467, ov at 530 with 336 tests, lv at 469 with 122
