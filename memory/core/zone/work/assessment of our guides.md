...
**Direct evidence:** ov's [code debt](../../../../core/ov/notes/work/code%20debt.md) done list runs to a hundred lines, and nothing prompts the move to a paid file.
...
- [keep shop](develop/keep%20shop.md) — keeping the note files in a manner that still guides the next session.
