...
- S: filter tree brought up, both halves: the code folder and the memory folder taken whole from ov, to be pruned by hand. Registered in ports.json (5187), mono's package.json, servers.sh and the hub (badge H). Everything below this line is ov's
