...
2. **Scrolling re-measures everything.** `recalibrate` builds a new tree and reads every target's rectangle — [Hits.ts:149-159](../../../../../ov/src/lib/ts/events/Hits.ts#L149-L159) — and it runs on every scroll event of the list ([Files.svelte:207](List_Files.svelte#L207)) and of the file's words ([Edit_Markdown.svelte:867](Edit_Markdown.svelte#L867)). Each rectangle read forces the browser to settle layout. This is the heaviest thing in the change.
...
2. **A scroll shifts rectangles by the distance scrolled** — [Hits.ts:181-192](../../../../../ov/src/lib/ts/events/Hits.ts#L181-L192), asked by the list ([Files.svelte:209-217](List_Files.svelte#L209-L217)) and the file's words ([Edit_Markdown.svelte:66-72](Edit_Markdown.svelte#L66-L72)). Nothing is read from the browser; asking which targets are inside a box walks up from each element, which forces no layout.
