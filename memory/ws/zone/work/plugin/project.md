...
Deeper Dives, beyond the scope of this file, [can be found here](memory/ws/zone/notes/index.md).
## Table of Contents
...
See [architecture/core/state.md](state.md) for state objects, stores inventory, and why we use this hybrid approach.
...
See [architecture/core/managers.md](../../../truth/architecture/core/managers.md) for complete responsibilities, access patterns, and examples.
...
See [architecture/internals/persistable.md](persistable.md) for identity, serialization, and lifecycle.

#### 4. Database Abstraction

Supports 5 database backends: Local (IndexedDB), Firebase, Airtable, Bubble plugin, and Test (in-memory).

See [architecture/core/databases.md](databases.md) for architecture, switching, and implementation.
...
See [architecture/core/components.md](../../../truth/architecture/core/components.md) for organization, patterns, state management, and Components manager.

#### 6. Hit Testing & Hover

Centralized hit testing with RBush spatial indexing. Priority: dots > widgets > rings > controls > rubberband.

See [architecture/core/hits.md](hits.md) for complete click system (autorepeat, long-click, double-click), migration guide, testing.

#### 7. Geometry Layout

Coordinates layout algorithms for tree and radial graph modes.

See [architecture/core/geometry.md](../../../truth/architecture/core/geometry.md) for responsibilities, layout invocation, and coordination patterns.
...
**Index**: [index.md](memory/ws/zone/notes/index.md) - Complete index of all design documentation

**Architecture** (architecture/):
- [buttons.md](buttons.md) - Button hierarchy, SVG icons
- [components.md](../../../truth/architecture/core/components.md) - Component architecture: organization and Components manager
- [controls.md](../../../truth/architecture/ux/controls.md) - Control components
- [database.md](databases.md) - Database abstraction layer
- [details.md](../../../truth/architecture/ux/details.md) - Details panel architecture
- [geometry.md](../../../truth/architecture/core/geometry.md) - Layout coordination and positioning
- [hits.md](hits.md) - Click/hover system, migration guide
- [managers.md](../../../truth/architecture/core/managers.md) - Singleton manager pattern and responsibilities
- [paging.md](paging.md) - Radial paging system
- [persistable.md](persistable.md) - Persistable data models and serialization
- [preferences.md](../../../truth/architecture/ux/preferences.md) - Settings management
- [search.md](../../../truth/architecture/ux/search.md) - Search functionality
- [state.md](state.md) - State objects and stores architecture
- [styles.md](./guides/architecture/internals/styles.md) - Styling system
- [ux.md](ux.md) - UX manager (focus, grabs, details)
