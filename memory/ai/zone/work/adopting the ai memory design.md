...
- CLAUDE files made first-class in ov and the dispatcher; three case bugs fixed; recorded in [claude-files.md](../../truth/design/claude-files.md); all CLAUDE files renamed lowercase.
...
- Move `memory/ov/notes/guides/pre-flight/lexicon.md` into [truth/lexicon.md](../../truth/lexicon.md).
