...
Done, 29 August 2026 — the old file's terms merged into memory/ai/truth/lexicon.md ('title on a sep' superseded by clickable, the filters entry updated to multi-pick), the old file removed, CLAUDE.md re-pointed, ov's open question struck.
