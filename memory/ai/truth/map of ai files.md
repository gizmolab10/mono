...
- [common/Core.ts](../../../ai/src/lib/ts/common/Core.ts) — everything ai adopts from core, one line each, through the "core" alias: the configuration calls, the sizes, the colors, the log and, since step 9, the Preferences class. **⟵core**
