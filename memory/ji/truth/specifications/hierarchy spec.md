...
Source read: [ws Hierarchy.ts](../../../../../ji/ws/src/lib/ts/managers/Hierarchy.ts). ji's side: [DB_Records.ts](../../ji/src/lib/ts/types/DB_Records.ts) (the record structures), [DB_Common.ts](../../ji/src/lib/ts/database/DB_Common.ts) (the store), [Indexes.ts](../../ji/src/lib/ts/database/Indexes.ts) (the in-memory lookups), and [Documents.svelte](../../ji/src/lib/svelte/main/Documents.svelte) (the table).
