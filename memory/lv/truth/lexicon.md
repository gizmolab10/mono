...
- **remote hosted storage** — a rented folder on somebody else's computer, reachable at a web address, where each file has its own address and nothing of ours runs. Cloudflare, Amazon and Backblaze rent it. Not: a bucket — never call one that.
