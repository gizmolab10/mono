...
**Current state:** lexicon folded in from CLAUDE.md — the migration's first move (changed to inception, on 28 August 2026); the gallery truth stands current. Open: which remote hosted storage, if the pictures outgrow the repo.
