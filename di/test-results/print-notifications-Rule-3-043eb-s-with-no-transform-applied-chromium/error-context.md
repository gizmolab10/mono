...
- Name: print-notifications.spec.ts >> Rule 39 — an empty scene leaves the canvas with no transform applied
- Location: e2e/tests/print-notifications.spec.ts:379:1
...
Expected: ""
Received: "translate(-26.7804px, -74.424px) scale(1.16436)"
```
