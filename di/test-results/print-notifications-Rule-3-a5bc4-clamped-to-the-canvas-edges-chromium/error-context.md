...
- Name: print-notifications.spec.ts >> Rule 39 — a box that extends past the visible frame has its silhouette clamped to the canvas edges
- Location: e2e/tests/print-notifications.spec.ts:290:1
...
Received difference:   0.4763599999999999
```
