...
- Name: print-notifications.spec.ts >> Rule 39 — two boxes far apart in world space produce a silhouette that contains both
- Location: e2e/tests/print-notifications.spec.ts:255:1
...
Expected: 1.509650000922317
Received: 1.47636

Expected precision:    3
Expected difference: < 0.0005
Received difference:   0.03329000092231715
```
