...
The library panel shows every saved arrangement (both the ones that are bundled with the app and the ones you have saved yourself). Click a row, then press **replace**, and the chosen arrangement becomes your current scene. The previous working scene is replaced.
