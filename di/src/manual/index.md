...
## The first drawing — a drawer
 ...
 ![The drawer fresh from the bundled default, with the side panel on the right.](images/first-steps/01-opening.png) *The drawer fresh from the bundled default, with the side panel on the right.*
...
### Showing dimensionals
 ...
 ![Three small numbers floating beside three of the drawer's edges.](images/first-steps/02-dimensions-on.png) *Three small numbers floating beside three of the drawer's edges.*

In the toolbar, the segmented control near the center has three buttons — names, dimensions, angles. Click "dimensions". Three small numbers appear beside three of the drawer's edges, one for each axis. The numbers are formatted in your chosen unit family (imperial by default).

Citation: the toggle is wired at `src/lib/svelte/main/Controls.svelte` line 70.

### Trying to stretch — the lock

 ![A grab-hand cursor hovering near a corner — nothing moves while editing is locked.](images/first-steps/03-locked-cursor.png) *A grab-hand cursor hovering near a corner — nothing moves while editing is locked.*
...
### Turning on editing
 ...
 ![A close-up of the toolbar's edit button showing the padlock icon.](images/first-steps/04-toolbar-padlock.png) *A close-up of the toolbar's edit button showing the padlock icon.*
...
### Stretching the drawer
 ...
 ![Mid-drag — the drawer corner pulled to a new size.](images/first-steps/05-mid-stretch.png) *Mid-drag — the drawer corner pulled to a new size.*
...
### Editing a dimensional
 ...
 ![The dimension input overlaid on the drawer, ready for a new value.](images/first-steps/06-dimension-input.png) *The dimension input overlaid on the drawer, ready for a new value.*
...
## Creating a new design
 ...
 ![A blank drawing surface — the new scene's root is invisible by default.](images/first-steps/07-blank-canvas.png) *A blank drawing surface — the new scene's root is invisible by default.*
...
### Adding an empty box
 ...
 ![The drawing surface after a new child part has been added inside the root.](images/first-steps/08-fresh-child.png) *The drawing surface after a new child part has been added inside the root.*
