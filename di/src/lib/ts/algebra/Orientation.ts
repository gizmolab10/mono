 ...
 */
export function orientation_from_bounds(so: Smart_Object): quat {
 ...
 */
export function recompute_orientation(so: Smart_Object): void {
	if (so.fixed) return;
 ...
 * to the new angle.
 */
export function recompute_max_bounds_from_rotation(so: Smart_Object): void {
