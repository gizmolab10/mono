...
For the case-level writing — exactly what was tried, what failed, and why — see [the facet-tracer lessons file](di/di%20notes/di%20work/milestones/done/32.facets/lessons.md) and [the drag lessons file](di/di%20notes/di%20work/milestones/33.drag/lessons.md).
