...
kind: design
title: "3D Primer"
description: "The 3D ideas that came up during di, explained for Jonathan."
tags: [geometry, research, stow]
date: 2026-05-10
---
# Primer
...
Flatbush (a static 2D R-tree) replaces the O(n) face scan with O(log n) per edge, culling ~90%+ of candidates before the narrow-phase Cyrus-Beck clipping test runs. At kitchen scale, that's the difference between choking and smooth. 
