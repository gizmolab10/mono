...
- **Seeded semantics** — inside a full search seeded by the previous paint, labels that still possess viability stay locked at their carry-over values; only labels that lost viability are searched for fresh. Detail in rule 19.
