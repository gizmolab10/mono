...
**validation — phantom stairs:** extend the stair pattern by one in each direction. step[-1] should sit just below floor. step[count] should be done just beyond the top. if both match, the geometry is right.
...
See [repeaters](di/di%20notes/di%20guides/di%20architecture/graph/repeaters.md)
...
- [x] stairs s&l increase to include "phantom" (hidden) top stair and bottom being done stair
