...
That triggered a cascade. Svelte 5 had just shipped. Why start with 4 and migrate later? So: Svelte 5 from day one, runes instead of stores, `mount()` instead of `new Component()`. Wrote a migration guide anyway [[di/notes/work/done/svelte]] to document the resulting files, installs and configuration.
