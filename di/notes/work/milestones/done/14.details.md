...
- [x] move all of d selected part into d parts, below the list, add a sep div between them
...
- [ ] move explicit/agnostic button in d attributes -> centered above the table
- [ ] add file hierarchy -> [[17.library]]
	- [ ] ability to collapse hierarchy
- [ ] ability to collapse parts
- [ ] new section in d parts (use a sep div)
