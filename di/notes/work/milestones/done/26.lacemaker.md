...
**References:** [simpler design.md](simpler%20design.md) for design specification. [handoff.md](di/di%20notes/di%20work/milestones/done/32.facets/slow/handoff.md) for dead ends, and solved items.
...
Delete the pierce-occlusion merge, pierce-pierce tier 1, and pierce-pierce tier 2. All proven dead by step 8. The pierce-at-vertex-corner merge stays — it solves a different problem (intersection line falling exactly on a mesh vertex).
