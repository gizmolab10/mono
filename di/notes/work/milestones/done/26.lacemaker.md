...
**References:** [simpler design.md](simpler%20design.md) for design specification. [handoff.md](di/notes/work/milestones/done/32.facets/slow/handoff.md) for dead ends, and solved items.
