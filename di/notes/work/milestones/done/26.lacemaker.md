...
**Status:** DONE. 46 tests passing, svelte-check clean. 7 facets painting (was 0). **Test case:** facet #5 l→j→g→G→l on face HGCD paints correctly. ✓ **References:** [simpler design.md](simpler%20design.md) for design specification. [handoff.md](di/notes/work/milestones/done/32.facets/slow/handoff.md) for dead ends, and solved items.
