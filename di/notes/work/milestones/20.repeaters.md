...
- [ ] how can engine keep track of templates, clones and fire blocks?
- [ ] walls
	- [ ] fire blocks every 4' when wall height > 8'
	- [ ] convert stud distance constraint to slider
	- [ ] convert range to a toggle (range <--> static)
...
- [x] stairs
	...
	- [x] adjust tread depth according to run
		...
		- [ ] add a new slider for "percentage nosing"
