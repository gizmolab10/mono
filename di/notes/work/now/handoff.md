...
- Rule fourteen's text in [uniface rules](uniface%20rules.md) still says "within 20° of the camera's forward" — a single angle. The implementation uses 20° front, 45° back. The rules file still wants an edit to match.
