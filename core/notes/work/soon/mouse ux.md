...
**The step buttons stepped twice.** The manager said the press and started the repeating, and the repeating begins with a beat at once. Where the second step arrived back at the first, it read as doing nothing.
...
[List_Files.svelte:427-437](../../../src/lib/svelte/content/List_Files.svelte#L427-L437), [Steppers.svelte:43-49](../../../src/lib/svelte/support/Steppers.svelte#L43-L49)
