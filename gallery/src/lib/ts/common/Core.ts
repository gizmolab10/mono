// Everything (currently) gallery adopts from core, in one file. Each line says where the
// thing really lives — through the "core" alias that tsconfig and vite.config both
// know. Only this file reaches through the alias; every other gallery file imports here.
//
// The stylesheet is the one thing that does not pass through: main.ts imports gallery's
