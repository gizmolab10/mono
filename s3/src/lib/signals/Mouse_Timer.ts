...
export class Mouse_Timer {
	autorepeat_start_timer: ReturnType<typeof setTimeout> | null = null;
	doubleClick_timer:      ReturnType<typeof setTimeout> | null = null;
	autorepeat_timer:       ReturnType<typeof setInterval> | null = null;
	alteration_timer:       ReturnType<typeof setInterval> | null = null;
	...
	// ————————————————————————————————————————— Timeout (long-click / double-click)

	timeout_start(type: T_Timer, callback: () => void, force_reset: boolean = false) {
