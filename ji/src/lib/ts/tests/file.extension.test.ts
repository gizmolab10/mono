...
const KINDS: Kind_Row[] = [
	...
	{ kind: E.tsv,     name: 'rows.tsv',      type: 'text/tab-separated-values', content: 'name\tcount\nALPHA\t1\nBETA\t2\n', family: F.sheet, showable: false, readiness: S.ready },
	{ kind: E.psv,     name: 'rows.psv',      type: '',         content: 'name|count\nALPHA|1\nBETA|2\n', family: F.sheet, showable: false, readiness: S.ready },
	{ kind: E.dif,     name: 'rows.dif',      type: '',         content: 'TABLE\n0,1\n"ALPHA"\nVECTORS\n0,2\n""\n', family: F.sheet, showable: false, readiness: S.ready },
	{ kind: E.slk,     name: 'rows.slk',      type: '',         content: 'ID;PALPHA\nC;X1;Y1;K"count"\nE\n', family: F.sheet, showable: false, readiness: S.ready },
	{ kind: E.xls,      name: 'rows.xls',      type: 'application/vnd.ms-excel', content: bytes(0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1, 0x01), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xlsx,     name: 'rows.xlsx',     type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', content: bytes('PK', 0x03, 0x04, 0x14, 0x01), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xlsm,     name: 'rows.xlsm',     type: 'application/vnd.ms-excel.sheet.macroEnabled.12', content: bytes('PK', 0x03, 0x04, 0x14, 0x02), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xlsb,     name: 'rows.xlsb',     type: 'application/vnd.ms-excel.sheet.binary.macroEnabled.12', content: bytes('PK', 0x03, 0x04, 0x14, 0x03), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xlt,      name: 'blank.xlt',     type: 'application/vnd.ms-excel', content: bytes(0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1, 0x02), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xltx,     name: 'blank.xltx',    type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.template', content: bytes('PK', 0x03, 0x04, 0x14, 0x04), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.xltm,     name: 'blank.xltm',    type: 'application/vnd.ms-excel.template.macroEnabled.12', content: bytes('PK', 0x03, 0x04, 0x14, 0x05), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.ods,      name: 'rows.ods',      type: 'application/vnd.oasis.opendocument.spreadsheet', content: bytes('PK', 0x03, 0x04, 0x14, 0x06), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.ots,      name: 'blank.ots',     type: 'application/vnd.oasis.opendocument.spreadsheet-template', content: bytes('PK', 0x03, 0x04, 0x14, 0x07), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.gnumeric, name: 'rows.gnumeric', type: 'application/x-gnumeric', content: bytes(0x1F, 0x8B, 0x08, 0x00), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.wk1,      name: 'rows.wk1',      type: '', content: bytes(0x00, 0x00, 0x02, 0x00, 0x06, 0x04), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.wk3,      name: 'rows.wk3',      type: '', content: bytes(0x00, 0x00, 0x1A, 0x00, 0x00, 0x10), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.wk4,      name: 'rows.wk4',      type: '', content: bytes(0x00, 0x00, 0x1A, 0x00, 0x02, 0x10), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.qpw,      name: 'rows.qpw',      type: '', content: bytes(0x00, 0x00, 0x02, 0x00, 0x51, 0x50), family: F.sheet, showable: false, readiness: S.heavy },
	{ kind: E.wb3,      name: 'rows.wb3',      type: '', content: bytes(0x00, 0x00, 0x02, 0x00, 0x57, 0x42), family: F.sheet, showable: false, readiness: S.heavy },
