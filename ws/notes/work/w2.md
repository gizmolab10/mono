...
**Started:** 2026-02-07
**Status:** Phase 1 — Design Spec (not started)

## Goal

Rewrite ws as w2: a clean Svelte 5 port following the . Full design spec first, then architectural decisions, then fresh build. Eliminate cruft and ad-hoc logic.

## Phases

1. **Design spec** — read every file, document what each subsystem does
2. **Architectural decisions** — choose patterns for hierarchy, signals, reactivity
...
Choose hierarchy architecture and signal system approach, then begin Phase 1 design spec.
